...
.catch(error=>{
 ...
 //function for select region
  ...
  if(!confirmPassword){
    confirmPasswordErr.nomatch="password not mentioned";
  }
  if(setConfirmPassword!==setPassword){
    confirmPasswordErr.nomatch="not matched"
  }
  //Address validation
  if(!address){
   ...
   <div className="offset-2"> 
      ...
      <div className="form-group">
           ...
           <div className="text-center">
                <button id="loansubmit" className="btn btn-primary mr-1" onClick={(e)=>submitHandler(e)} > Register </button>
